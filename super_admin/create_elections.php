                ...
                <div class="card-body">
                    ...
                    <div id="positionsContainer" class="mb-4">
                        ...
                        foreach ($candidates as $candidate) {
                            $groupedCandidates[$candidate['position_id']]['position_name'] = $candidate['position_name'];
                            $groupedCandidates[$candidate['position_id']]['candidates'][] = $candidate;
                        }

                        // Now render the grouped candidates
                        foreach ($groupedCandidates as $position_id => $group):
                            ?>
                            <div class="position-card mb-4 p-4 border rounded-3 bg-light-subtle shadow-sm">
                                ...
                                <div class="candidatesContainer row g-4 mb-4"> <!-- Added mb-4 for bottom margin -->
                                    <?php foreach ($group['candidates'] as $index => $candidate): ?>
                                        <div class="col-md-6 col-lg-4 mb-3"> <!-- Added mb-3 for individual candidate spacing -->
                                            <div class="candidate-card p-3 border rounded-3 bg-white shadow-sm h-100">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control-plaintext font-weight-bold" name="candidates[<?= $candidate['candidate_id'] ?>][name]" value="<?= htmlspecialchars($candidate['name']) ?>" readonly>
                                                </div>
